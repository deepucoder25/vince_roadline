  ...
  <div class="container">
    ...
    <div class="vrl-simple-content-box p-4 p-md-5 mb-5">
      ...
      <p class="vrl-about-prose text-muted mb-4">
        With over <?= $exp_num ?>+ years of packing mastery and <?= number_format($clients_num) ?>+ successful moves, our trained packing crew uses heavy-duty 3-layer bubble wrap, corrugated cardboard sheets, edge foam protectors, stretch film, and custom wooden crating to guarantee 100% safety.
      </p>
